...
const EmojiPicker = ({ isOpen, onSelect, onClose }) => {
    ...
    return (
        <div className="absolute bottom-14 right-0 bg-white rounded-lg shadow-xl border border-gray-200 p-4 w-80 h-64 overflow-y-auto z-20 animate-in fade-in slide-in-from-bottom-2 duration-200">
