  ...
  return (
    <div className="w-full py-10 px-4" style={{ backgroundColor: '#f0f4ff' }}>
      <div className="max-w-8xl  px-6 mx-auto">
        {/* Header Section */}
        <div className="mb-12">
          <p className="text-[#ff5a00] uppercase tracking-widest text-xs md:text-sm font-semibold mb-4 letter-spacing-wide">
            SPECIALIZATION
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-[#ff5a00] font-semibold text-lg">{activeTab}</h3>
            </div>
