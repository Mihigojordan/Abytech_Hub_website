...
const SEED_COMPANIES = [
  ...
  },
  {
    id: 'company-seed-8',
    registrationId: null,
    businessName: 'Musanze Highland Supermarket',
    businessType: 'Supermarket',
    businessTypeOther: '',
    address: 'RN4, Musanze Town',
    city: 'Musanze',
    country: 'Rwanda',
    contactName: 'Beatrice Nyirahabimana',
    contactRole: 'Store Manager',
    email: 'beatrice@highlandmart.rw',
    phone: '+250 788 111 909',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['order-management', 'stock-management', 'procurement', 'finance', 'payroll', 'reports'],
    planId: 'plan-pro',
  ...
  },
  {
    id: 'company-seed-9',
    registrationId: null,
    businessName: 'Akagera Safari Lodge',
    businessType: 'Hotel',
    businessTypeOther: '',
    address: 'Akagera National Park Rd',
    city: 'Nyagatare',
    country: 'Rwanda',
    contactName: 'Robert Twagirayezu',
    contactRole: 'Lodge Manager',
    email: 'robert@akagerasafari.rw',
    phone: '+250 788 121 232',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['reservations', 'finance', 'hr-leave', 'loyalty', 'reports'],
    planId: 'plan-enterprise',
  ...
  },
  {
    id: 'company-seed-10',
    registrationId: null,
    businessName: 'Rusizi Riverside Bar',
    businessType: 'Bar',
    businessTypeOther: '',
    address: 'Riverside Ave, Kamembe',
    city: 'Rusizi',
    country: 'Rwanda',
    contactName: 'Alice Uwamahoro',
    contactRole: 'Owner',
    email: 'alice@rusiziriverside.rw',
    phone: '+250 788 434 545',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['order-management', 'pos', 'reports'],
    planId: 'plan-starter',
  ...
  },
  {
    id: 'company-seed-11',
    registrationId: null,
    businessName: 'Kigali Fashion Boutique',
    businessType: 'Shop',
    businessTypeOther: '',
    address: 'KN 5 Rd, City Centre',
    city: 'Kigali',
    country: 'Rwanda',
    contactName: 'Grace Umutoni',
    contactRole: 'Owner',
    email: 'grace@kigalifashion.rw',
    phone: '+250 788 656 767',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['order-management', 'reports'],
    planId: 'plan-free',
    createdAt: daysAgo(1),
  },
  {
    id: 'company-seed-12',
    registrationId: null,
    businessName: 'Muhanga Bakery & Café',
    businessType: 'Other',
    businessTypeOther: 'Bakery',
    address: 'NR3, Muhanga Town',
    city: 'Muhanga',
    country: 'Rwanda',
    contactName: 'Providence Iradukunda',
    contactRole: 'Owner',
    email: 'providence@muhangabakery.rw',
    phone: '+250 788 878 989',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['order-management', 'pos', 'menu-management'],
    planId: 'plan-starter',
  ...
  },
  {
    id: 'company-seed-13',
    registrationId: null,
    businessName: 'Karongi Lakeview Lounge',
    businessType: 'Lounge',
    businessTypeOther: '',
    address: 'Lake Kivu Shoreline',
    city: 'Karongi',
    country: 'Rwanda',
    contactName: 'Samuel Nkurikiyimfura',
    contactRole: 'Manager',
    email: 'samuel@lakeviewlounge.rw',
    phone: '+250 788 989 090',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['order-management', 'pos', 'reservations', 'loyalty', 'reports'],
    planId: 'plan-pro',
  ...
  },
  {
    id: 'company-seed-14',
    registrationId: null,
    businessName: 'Remera Grill House',
    businessType: 'Restaurant',
    businessTypeOther: '',
    address: 'KG 17 Ave, Remera',
    city: 'Kigali',
    country: 'Rwanda',
    contactName: 'Theogene Habimana',
    contactRole: 'Owner',
    email: 'theogene@remeragrill.rw',
    phone: '+250 788 767 878',
    status: COMPANY_STATUS.SUSPENDED,
    moduleAccess: ['order-management', 'pos'],
    planId: 'plan-starter',
  ...
  },
  {
    id: 'company-seed-15',
    registrationId: null,
    businessName: 'Nyabugogo Wholesale Shop',
    businessType: 'Shop',
    businessTypeOther: '',
    address: 'Nyabugogo Market',
    city: 'Kigali',
    country: 'Rwanda',
    contactName: 'Deo Nsengimana',
    contactRole: 'Owner',
    email: 'deo@nyabugogowholesale.rw',
    phone: '+250 788 545 656',
    status: COMPANY_STATUS.ACTIVE,
    moduleAccess: ['order-management', 'stock-management'],
    planId: null,
