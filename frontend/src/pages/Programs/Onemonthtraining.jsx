...
const OneMonthTraining = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50">
      <Header title="1 Month Training" path="training/one-month" />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-white text-center">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 max-w-4xl mx-auto">
            Fast-track your programming career with our intensive 1-month bootcamp
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              Our intensive 1-month program is designed for individuals who want to quickly gain 
              fundamental programming skills. This bootcamp covers essential concepts and provides 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center">
              ...
              <p className="text-4xl font-bold text-[#ff5a00] mb-2">4 Weeks</p>
              <p className="text-gray-600">Full-time intensive</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center">
              <div className="text-5xl mb-4">⏰</div>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1920&h=600&fit=crop')",
      ...
      >
        ...
        <div className="container mx-auto px-4 z-10 text-center text-white">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Intensive, hands-on training that gets you coding from day one
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto">
              A structured learning path designed to build your skills progressively
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start gap-2">
                          ...
                          <span>Introduction to Programming Concepts</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">•</span>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
                          <span>Calculator Application</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
                          <span>To-Do List Console App</span>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            {/* Week 2 */}
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-8 rounded-2xl shadow-xl">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 bg-[#ff5a00] rounded-full flex items-center justify-center text-white text-2xl font-bold">
                  2
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">•</span>
                          <span>Dictionaries & Hash Maps</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">•</span>
                          <span>Basic Algorithms (Sorting, Searching)</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">•</span>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
                          <span>Simple Search Engine</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
            ...
            {/* Week 3 */}
            <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-8 rounded-2xl shadow-xl">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 bg-[#ff5a00] rounded-full flex items-center justify-center text-white text-2xl font-bold">
                  3
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
                          <span>Interactive Landing Page</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
                          <span>Simple Web Game</span>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-2xl shadow-xl">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-gray-800 mb-4">
                    Week 4: Final Project & Career Prep
                  </h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-bold text-gray-800 mb-2">Topics Covered:</h4>
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">•</span>
                          <span>Best Practices & Code Quality</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">•</span>
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 mb-2">Final Project:</h4>
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start gap-2">
                          <span className="text-[#ff5a00]">✓</span>
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: "💻", title: "Programming Languages", desc: "Python or JavaScript fundamentals" },
              { icon: "🎨", title: "Web Development", desc: "HTML, CSS, and responsive design" },
              { icon: "📊", title: "Data Structures", desc: "Arrays, lists, and dictionaries" },
              { icon: "⚙️", title: "Algorithms", desc: "Problem-solving and logic building" },
              { icon: "🔧", title: "Developer Tools", desc: "Git, VS Code, and debugging" },
              { icon: "🚀", title: "Best Practices", desc: "Clean code and industry standards" }
            ].map((item, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 text-center">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1920&h=800&fit=crop')",
          backgroundAttachment: "fixed",
          backgroundPosition: "center",
          backgroundSize: "cover",
        }}
      >
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="grid md:grid-cols-4 gap-8 text-center text-white">
            ...
            <div className="space-y-2">
              <div className="text-6xl md:text-7xl font-bold text-[#ff5a00]">4.8/5</div>
              <div className="text-xl md:text-2xl">Student Rating</div>
            </div>
            <div className="space-y-2">
              <div className="text-6xl md:text-7xl font-bold text-[#ff5a00]">15:1</div>
              <div className="text-xl md:text-2xl">Student-Teacher Ratio</div>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white p-6 rounded-xl">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <span className="text-[#ff5a00]">✓</span>
                      <span>4 weeks of intensive training</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#ff5a00]">✓</span>
                ...
                <div className="bg-white p-6 rounded-xl">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <span className="text-[#ff5a00]">✓</span>
                      <span>Career counseling session</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#ff5a00]">✓</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-[#ff5a00]">✓</span>
                      <span>Interview preparation workshop</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#ff5a00]">✓</span>
      ...
      <section className="relative py-32 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1920&h=800&fit=crop')",
            backgroundAttachment: "fixed",
            backgroundPosition: "center",
            backgroundSize: "cover",
          }}
        ...
        <div className="container mx-auto px-4 z-10 relative text-center text-white">
          ...
          <p className="text-2xl md:text-3xl mb-12 max-w-4xl mx-auto">
            Join our next cohort and transform your career in just 4 weeks
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
...
export default OneMonthTraining;