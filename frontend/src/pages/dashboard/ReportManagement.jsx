          ...
          >
            ...
            {!searchTerm && dateFilter === 'ALL' && (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleCreateReport}
                className="inline-flex items-center space-x-2 text-white px-2 py-2 rounded-lg font-medium shadow-md text-xs bg-gradient-to-r from-[#1d293d] to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
              >
                    ...
                    {selectedReport.content ? (
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <a
                          ...
                          className="text-[#1d293d] hover:underline text-xs"
                        >
                          {selectedReport.reportUrl}
                        </a>
                      </div>
